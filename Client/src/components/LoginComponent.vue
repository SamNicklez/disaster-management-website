...
<template>
    <div class="login-card">
        ...
        <v-card class="mx-auto pa-12 pb-8" id="card" elevation="8" rounded="lg" style="margin-bottom: 10vh;">
            ...
            <v-alert v-model="alert" density="compact" variant="outlined" type="warning"
                :text="alertText" dismissible><v-icon icon="mdi-close-box-outline" size="large" style="float:right" @click="this.alert=false"></v-icon></v-alert>
            ...
            <v-card class="mb-12" color="#313638" variant="tonal">
                <v-card-text class="text-medium-emphasis text-caption">
                    ...
                    minutes. If you must login now, you can also click "Forgot login password?" below to reset the login
                    password.
                </v-card-text>
            </v-card>
