...
INSERT INTO `request` VALUES (7,13,1,0,'2024-03-12 16:23:40',NULL),(8,13,1,1,'2024-03-12 16:24:17',NULL),(9,14,1,0,'2024-03-12 16:24:38',NULL),(10,15,1,0,'2024-03-12 16:25:15',NULL),(11,15,1,0,'2024-03-12 17:16:01',NULL);
...
CREATE TABLE `response` (
  ...
  KEY `response_ibfk_1_idx` (`request_id`),
  CONSTRAINT `response_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `request` (`request_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `response` VALUES (2,7,1,NULL,'2024-03-25 16:01:55',NULL),(3,7,1,NULL,'2024-03-25 18:50:13',NULL),(4,8,1,NULL,'2024-03-25 19:30:45',NULL);
/*!40000 ALTER TABLE `response` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `responseitem`
--

DROP TABLE IF EXISTS `responseitem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `responseitem` (
  ...
  KEY `responseitem_ibfk_1_idx` (`response_id`),
  KEY `responseitem_ibfk_2_idx` (`item_id`),
  CONSTRAINT `responseitem_ibfk_1` FOREIGN KEY (`response_id`) REFERENCES `response` (`response_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `responseitem_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`ItemID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `responseitem`
--

LOCK TABLES `responseitem` WRITE;
/*!40000 ALTER TABLE `responseitem` DISABLE KEYS */;
INSERT INTO `responseitem` VALUES (1,2,101,25),(2,3,101,25),(3,4,105,25);
/*!40000 ALTER TABLE `responseitem` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-25 19:47:41
